...
\address{\parbox{0.9\linewidth}{%
		\centering 
		 ...
		 Office: B-010, Department of EECS, IIT Bhilai,\\
...
\begin{enumerate}
\item \textbf{A Study of APIs for Graph Analytics Workloads}, Hochan Lee, David Wongy, Loc Hoang, Roshan Dathathri, Gurbinder Gill, \textbf{Vishwesh Jatala}, David Kucky, and Keshav Pingali, in IEEE International Symposium on Workload Characterization \& Distributed Processing Symposium \textbf{(IISWC)}, 2020 [To appear].
...
\end{itemize}
\item Evaluated master thesis of a student at Norwegian University of Science and Technology University (NTNU)
\end{itemize}
